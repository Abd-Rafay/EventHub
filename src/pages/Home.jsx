  ...
  return (
    <>
      ...
      <section className="py-5 bg-white mb-5">
        <div className="container">
          <h2 className="text-center fw-bold mb-3">Why Choose EventHub?</h2>
          <p className="text-center text-muted mb-5">
            We're more than just an event platform. We're your partner in
            discovering experiences that enrich your life and connect you with
            your community.
          </p>{" "}
          <div className="row">
            <div className="col-md-3 mb-4 mb-md-0">
              <div className="text-center p-4 border rounded shadow-sm h-100 bg-light bg-opacity-25">
                <div
                  className="bg-orange-600 p-3 rounded-circle d-inline-flex justify-content-center align-items-center mb-3"
                ...
                <p className="text-muted small">
                  Find events that match your interests with our intuitive
            ...
            <div className="col-md-3 mb-4 mb-md-0">
              <div className="text-center p-4 border rounded shadow-sm h-100 bg-light bg-opacity-25">
                ...
                <p className="text-muted small">
                  We curate only the best events to ensure you have memorable
            ...
            <div className="col-md-3">
              <div className="text-center p-4 border rounded shadow-sm h-100 bg-light bg-opacity-25">
                ...
                <p className="text-muted small">
                  Discover events in your neighborhood or explore exciting
